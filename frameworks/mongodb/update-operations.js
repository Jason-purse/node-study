...
mongoose.connection.once('open', () => {
    ...
    // 部分更新,这里不需要更新部分,使用$set 操作符 ..
    // BookOperationModel.updateMany()
    // BookOperationModel.updateOne()
    // BookOperationModel.findOneAndUpdate()
    // BookOperationModel.findByIdAndUpdate()
